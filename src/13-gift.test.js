...
import {totalPrice, mostExpensive, globalMostExpensive, preferedKid, distributeGifts} from "./13-gifts.js";

suite("totalPrice", () => {
    test("returns total price of gifts", () => {
        const gifts = [{name: "iPhone", price: 800}, {name: "skateboard", price: 70}];
        expect(totalPrice(gifts)).toBe(870);
    });
});

suite("mostExpensive", () => {
    test("returns name of most expensive gift", () => {
        const gifts = [{name: "iPhone", price: 800}, {name: "skateboard", price: 70}];
...
suite("globalMostExpensive", () => {
    test("returns most expensive gift across all kids", () => {
        const kids = [
...
suite("preferedKid", () => {
    ...
    test("properly use the sum of all gifts to choose", () => {
        ...
        // Clara = 120, Nina = 110 → Clara gagne
